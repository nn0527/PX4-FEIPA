...
private:
	...
	float _thrust_override_filt{-1.f};  // first-order filtered override thrust (NED z, negative=up)
	...
	DEFINE_PARAMETERS(
		...
		(ParamFloat<px4::params::CEIL_DETACH_TO>) _param_ceil_detach_to,
	...
	hrt_abstime _distance_sensor_timestamp{0};
	int8_t _distance_sensor_instance{-1};
